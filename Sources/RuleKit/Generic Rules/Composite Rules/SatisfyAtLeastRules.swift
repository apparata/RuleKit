...
public extension Rule {
    ...
    static func atLeast(_ count: Int, of rules: Rule<Value>...) -> Rule<Value> {
        return SatisfyAtLeastRules(count, of: rules)
    }
    
    static func atLeast(_ count: Int, of rules: AnySequence<Rule<Value>>) -> Rule<Value> {
        return SatisfyAtLeastRules(count, of: rules)
    }
}

private class SatisfyAtLeastRules<Value>: Rule<Value> {
