...
public extension Rule {
    ...
    static func lessThan(_ count: Int, of rules: Rule<Value>...) -> Rule<Value> {
        return SatisfyLessThanRules(count, of: rules)
    }
    
    static func lessThan(_ count: Int, of rules: AnySequence<Rule<Value>>) -> Rule<Value> {
        return SatisfyLessThanRules(count, of: rules)
    }
}

private class SatisfyLessThanRules<Value>: Rule<Value> {
