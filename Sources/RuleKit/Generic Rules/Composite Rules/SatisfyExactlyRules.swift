...
public extension Rule {
    ...
    static func exactly(_ count: Int, of rules: Rule<Value>...) -> Rule<Value> {
        return SatisfyExactlyRules(count, of: rules)
    }
    
    static func exactly(_ count: Int, of rules: AnySequence<Rule<Value>>) -> Rule<Value> {
        return SatisfyExactlyRules(count, of: rules)
    }
}

private class SatisfyExactlyRules<Value>: Rule<Value> {
